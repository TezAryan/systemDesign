...
public:              //behaviours of car called as methods
...
*/
class SportsCar : public Car {     //sportscar is a type of car which is inherited from car
public:
    string brand;    //ye sab uska characters hai
    string model;
    bool isEngineOn;
    int currentSpeed;
    int currentGear;

    SportsCar(string b, string m) {    //constructor defined from
        this->brand = b;
        this->model = m;
        isEngineOn = false;
        currentSpeed = 0;
    ...
    void startEngine() {     //ye sab behaviours hai
        isEngineOn = true;
